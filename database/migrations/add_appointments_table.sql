...
-- This script creates the appointments table for the user-to-user appointment scheduling system
-- Date Format: DD/MM/YYYY (enforced at application level)
-- Features: Month view, Day Agenda view, Modal-based CRUD operations
...
-- Uncomment the following lines to insert test appointments
/*
